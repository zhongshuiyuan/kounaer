...
OpenLayers.Layer.Sogou = OpenLayers
		.Class(
				OpenLayers.Layer.XYZ,
				{
					name : "搜狗地图",
					...
					clone : function(obj) {
						if (obj == null) {
							obj = new OpenLayers.Layer.SOUGOU(this.name,
									this.url, this.getOptions());
						}
						obj = OpenLayers.Layer.XYZ.prototype.clone.apply(this,
								[ obj ]);
					...
					getURL : function(bounds) {
						...
						// trace(l + " row:" + blos + " col: " + blas + " x: " +
						// x
						// + " y: " + y);

						var strURL = "";
						strURL = tileUrls[num] + l + "/" + blos + "/" + blas
								+ "/" + x + "_" + y + ".png";
						console.info("搜狗地图瓦片：" + strURL);
						return strURL;
